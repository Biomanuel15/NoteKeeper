...
import com.biomanuel97.notekeeper.CourseInfo;
import com.biomanuel97.notekeeper.ModuleInfo;
import com.biomanuel97.notekeeper.NoteInfo;
...
//            ourInstance.initializeExampleNotes();
    ...
    private static void loadCoursesFromDatabase(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            dm.mCourses.add(new CourseInfo(courseId, courseTitle, null));
        }
        cursor.close();
    }
    ...
    private static void loadNotesFromDatabase(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            dm.mNotes.add(new NoteInfo(id, dm.getCourse(courseId), noteTitle, noteText));
        }
        cursor.close();
    }
    ...
    public NoteInfo getNoteById(int id) {
